...
static void add_param(uint8_t *buffer, uint8_t num_bytes) {
  ...
  db_out.print("buffer: ");
  db_out.printf("%u;%u;%u",recv_param_ptr,recv_param_buffer,buffer[2]);
  int ts = ((int)((sizeof recv_param_buffer) - (recv_param_ptr - recv_param_buffer)));
